# Training data
All training data is under the data folder. The adverserial inputs are in 'negative_nlu.yml' and the functional intents are in 'nlu.yml'

# Results
The results for each method are saved under the result folder. These results were generated with the testing data 'test/test_nlu.yml'. 

# Generating Adverserial input
The script used to generate adverserial input is under 'src/generate_examples' To generate examples you will need to add your Open AI API key.

Below are the instructions for training, testing and running the assitant.
